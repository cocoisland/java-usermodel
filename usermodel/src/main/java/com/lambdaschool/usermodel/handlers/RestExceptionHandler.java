...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	 ...
	 * handleResourceNotFoundException(ResourceNotFoundException rnfe) { ErrorDetail
	 * errorDetail = new ErrorDetail(); errorDetail.setTimestamp(new
	 * Date().getTime()); errorDetail.setStatus(HttpStatus.NOT_FOUND.value());
